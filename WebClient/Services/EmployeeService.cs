...
namespace WebClient.Services
{
    ...
    public class EmployeeService
    {
        ...
        {
            var responses = await _http.DeleteAsync($"api/employees/{id}");
        ...
        public async Task<bool> PostEmployeeAsync(EmployeeDTOs dto)
        {
            ...
            var responses = await _http.PostAsync("api/employees", content);
            return responses.IsSuccessStatusCode;
        }
        ...
        public async Task<bool> PutEmployeeAsync(int id,EmployeeDTOs dto)
        {
            dto.EmployeeId = id;
            using var content = new MultipartFormDataContent();
            ...
            var responses = await _http.PutAsync($"api/employees/{id}", content);
            return responses.IsSuccessStatusCode;
        }
    }
